...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-nonfree --enable-gpl --enable-libbluray --enable-libfaac --enable-libx264 --cpu=native --enable-lto --enable-x11grab --enable-static --disable-shared --extra-cflags=-DLIBTWOLAME_STATIC --enable-libfaac --enable-libmp3lame --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libtheora --enable-libvorbis --enable-postproc --enable-librtmp --enable-libass --enable-libxvid --enable-opencl --enable-version3 --enable-pthreads
prefix=/usr/local
...
CFLAGS=  -DLIBTWOLAME_STATIC  -std=c99 -fomit-frame-pointer -pthread -I/usr/include/freetype2 -I/usr/include/fribidi -I/usr/include/p11-kit-1 -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -flto -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla
CXXFLAGS=  -D__STDC_CONSTANT_MACROS
ASFLAGS=  -DLIBTWOLAME_STATIC  -g
AS_C=-c
AS_O=-o $@
CC_C=-c
CC_E=-E -o $@
...
LD_PATH=-L
DLLTOOL=
LDFLAGS=  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample -flto -O3 -fno-math-errno -fno-signed-zeros -fno-tree-vectorize
...
EXTRALIBS=-ldl -lXv -lX11 -lXext -lva -lXfixes -lXext -lX11 -ljack -lasound -lSDL -lOpenCL -lxvidcore -lx264 -lvorbisenc -lvorbis -logg -ltheoraenc -ltheoradec -logg -lrtmp -lz -lgnutls -lopencore-amrwb -lopencore-amrnb -lmp3lame -lfaac -lbluray -lass -lm -pthread -lbz2 -lz -lrt 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
...
libavfilter_VERSION=3.79.101
libavfilter_VERSION_MAJOR=3
libavfilter_VERSION_MINOR=79
libavformat_VERSION=55.12.100
